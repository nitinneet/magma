...
bool AsyncSubscriberdbServiceClient::get_subs_auth_info(
    const std::string& imsi, uint8_t imsi_length, amf_ue_ngap_id_t ue_id) {
...
bool AsyncSubscriberdbServiceClient::get_subs_auth_info_resync(
...
void AsyncSubscriberdbServiceClient::GetSubscriberAuthInfoRPC(
    M5GAuthenticationInformationRequest& request,
...
AsyncSubscriberdbServiceClient::AsyncSubscriberdbServiceClient() {
...
AsyncSubscriberdbServiceClient& AsyncSubscriberdbServiceClient::getInstance() {
  static AsyncSubscriberdbServiceClient instance;
  return instance;
}
